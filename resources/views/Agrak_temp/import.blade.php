<x-app-layout>
            ...
            <div class="max-w-2xl">
                ...
                <nav class="text-sm text-gray-500 whitespace-nowrap">
                    <ol class="flex items-center gap-1">
                        <li>
                            <a href="{{ route('agrak.index') }}" class="hover:text-gray-900 transition">
                                Agrak (Huerto)
                            </a>
                        </li>
                        <li>/</li>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Sube el archivo Excel del Huerto (Agrak). Se normaliza el código BIN y se evitan duplicados
                    por <strong>bin + fecha + hora</strong>.
                </p>
            </div>
            ...
            <div class="max-w-2xl">
                <div class="mt-3 flex flex-wrap items-center gap-2 text-xs">
                    ...
                    <span
                        ...
                        Evita duplicados por BIN + Fecha + Hora
                    </span>
                </div>
            </div>
    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow sm:rounded-lg p-6" x-data="agrakUploader()"
                ...
                <form method="POST" action="{{ route('agrak.import') }}" enctype="multipart/form-data"
                    @submit="onSubmit">
                    @csrf
                    ...
                    <div class="rounded-xl border-2 border-dashed p-6 transition"
                        ...
                        <div class="flex flex-col items-center text-center gap-2">
                            <div class="text-sm font-semibold text-gray-800">
                                Arrastra y suelta tu Excel de Agrak aquí
                            </div>
                            ...
                            <div class="mt-2 text-xs text-gray-400" x-show="!fileName">
                                Tip: si re-importas, los duplicados serán ignorados.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 flex items-center justify-between gap-3">
                        <div class="text-xs text-gray-500">
                            Columnas esperadas: Código bin, Fecha registro, Hora registro, Campo, Cuartel, Especie, etc.
                        </div>
