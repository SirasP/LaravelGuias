...
<x-app-layout>
    ...
    <template x-teleport="body">
        <div id="chartModal" class="fixed inset-0 z-[100] hidden items-center justify-center bg-black/60 backdrop-blur-md p-4 md:p-6" style="z-index: 9999;" onclick="if(event.target === this) closeExpandedChart()">
