        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center mb-4">
            ...
            <div class="flex gap-4 w-full sm:w-auto ">
                <a href="{{ route('fuelcontrol.productos.create') }}"
                    class="flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors shadow-sm w-full sm:w-auto">
