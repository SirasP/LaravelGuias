    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
            ...
            <a href="{{ route('fuelcontrol.vehiculos.create') }}"
                class="flex items-center justify-center gap-2 px-4 py-2.5 bg-green-600 text-white rounded-lg text-sm font-medium hover:bg-green-700 transition-colors shadow-sm w-full sm:w-auto">
