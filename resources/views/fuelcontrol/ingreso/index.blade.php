                                ...
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors group">
                                    ...
                                    <td class="px-6 py-4 text-center whitespace-nowrap">
                                        <div class="flex items-center justify-center gap-2">
                                            {{-- Detalle --}}
                                            <a href="{{ route('fuelcontrol.movimientos.detalle', $ingreso->id) }}" 
                                               class="w-8 h-8 rounded-xl bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 flex items-center justify-center hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition-all shadow-sm group"
                                               title="Ver Detalle">
