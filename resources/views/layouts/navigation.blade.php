...
-->
                    ...
                    <div x-data="{ openDocs: false }" class="relative">
                        ...
                        <button @click="openDocs = !openDocs" @click.away="openDocs = false" class="inline-flex items-start gap-2 px-4 py-2 rounded-full
    ...
    : 'text-gray-700 dark:text-gray-200' }}">
                        ...
                        <div x-show="openDocs" x-transition class="absolute left-0 mt-4 w-64 z-50
               rounded-2xl bg-white dark:bg-gray-900
               shadow-2xl border border-gray-100 dark:border-gray-700">
                            <a href="{{ route('pdf.index') }}" class="flex items-start gap-1 px-5 py-2 text-sm font-medium
                  hover:bg-indigo-50 dark:hover:bg-indigo-900/30">
                                <span class="h-3.5 w-3.5 rounded-full bg-indigo-500"></span>
                                PDFs importados
                            </a>

                            <a href="{{ route('pdf.import.form') }}" class="flex items-start gap-1 px-5 py-2 text-sm font-medium
                  hover:bg-indigo-50 dark:hover:bg-indigo-900/30">
                                <span class="h-3.5 w-3.5 rounded-full bg-indigo-500"></span>
                                Importar PDF
                            </a>
                    ...
                    <div x-data="{ openOdoo: false }" class="relative">
                        ...
                        <button @click="openOdoo = !openOdoo" @click.away="openOdoo = false" class="inline-flex items-center gap-2 px-4 py-2 rounded-full
               text-sm font-medium transition-all
               bg-gray-100 dark:bg-gray-800
               hover:bg-indigo-100 dark:hover:bg-indigo-900/40
    ...
    : 'text-gray-700 dark:text-gray-200' }}">
                        ...
                        <div x-show="openOdoo" x-transition class="absolute left-0 mt-4 w-64 z-50
               rounded-2xl bg-white dark:bg-gray-900
               shadow-2xl border border-gray-100 dark:border-gray-700">
                            <a href="{{ route('excel_out_transfers.index') }}" class="flex items-start gap-1 px-5 py-2 text-sm font-medium
                  hover:bg-indigo-50 dark:hover:bg-indigo-900/30">
                                <span class="h-3.5 w-3.5 rounded-full bg-indigo-500"></span>
                                Vista
                            </a>

                            <a href="{{ route('excel_out_transfers.import') }}" class="flex items-start gap-1 px-5 py-2 text-sm font-medium
                  hover:bg-indigo-50 dark:hover:bg-indigo-900/30">
                                <span class="h-3.5 w-3.5 rounded-full bg-indigo-500"></span>
                                Importar
                            </a>
    ...
    : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100' }}">
               ...
               border border-gray-200 dark:border-gray-700">
                    ...
                    <div x-data="{ openGuias: false }" class="relative">
                        ...
                        <!-- BOTÓN PRINCIPAL -->
                        <button @click="openGuias = !openGuias" class="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium transition
    ...
    : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100' }}">
                        ...
                        <!-- DROPDOWN PRINCIPAL -->
                        <div x-show="openGuias" x-transition @click.away="openGuias = false" class="absolute z-50 mt-2 w-56 rounded-xl shadow-lg
               bg-white dark:bg-gray-900
               border border-gray-200 dark:border-gray-700">
    ...
    : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100' }}">
            ...
            <div class="hidden sm:flex items-center">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800">
                            @auth
                                {{ Auth::user()->name }}
                            @endauth
