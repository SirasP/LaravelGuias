<x-app-layout>
    @php $canSeeValues = $canSeeValues ?? (auth()->user()?->canSeeValues() ?? true); @endphp
    <x-slot name="header">
        <div class="w-full grid grid-cols-1 lg:grid-cols-[auto,1fr,auto] items-center gap-3">
            <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-xs text-gray-400 mt-0.5">Listado boletas · {{ $documents->total() }} documentos</p>
                </div>
            </div>
            ...
            <form method="GET" class="hidden lg:block w-full lg:max-w-xl lg:justify-self-center">
                <div class="relative">
                    ...
                    @if($q)
                        <a href="{{ route('gmail.dtes.boletas.list') }}" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition">
                ...
                <div class="panel-toolbar">
                    ...
                    <div class="flex items-center gap-3 text-xs text-gray-400 shrink-0">
                        <span class="hidden sm:inline tabular-nums">
                            {{ $documents->total() }} boletas · pág. {{ $documents->currentPage() }}/{{ $documents->lastPage() }}
                        </span>
